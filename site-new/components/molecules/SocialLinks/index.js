...
const SocialLinks = () => (
  <>
    <a href='mailto:vincenzorm117@gmail.com' className='w-[30px] mx-4'>
      <IconEnvelope />
    </a>
    <a href='https://github.com/vincenzorm117' className='mx-4' target='_blank'>
      <svg
        height='30'
        viewBox='0 0 16 16'
    ...
    <a href='http://codepen.io/snowjumper/' className='mx-4' target='_blank'>
      <svg
        height='30'
        viewBox='0 0 16 16'
        xmlns='http://www.w3.org/2000/svg'
