...
export const NOTION_TYPE_NUMBERED_LIST_ITEM = 'numbered_list_item'
export const NOTION_TYPE_BULLETED_LIST = 'bulleted_list'
export const NOTION_TYPE_NUMBERED_LIST = 'numbered_list'
export const NOTION_TYPE_DIVIDER = 'divider'
export const NOTION_TYPE_TOGGLE = 'toggle'
export const NOTION_TYPE_QUOTE = 'quote'
export const NOTION_TYPE_VIDEO = 'video'
...
export const NOTION_TYPE_EMBED = 'embed'
export const NOTION_TYPE_SYNCED_BLOCK = 'synced_block'
